            ...
            <li key={item.name}>
              ...
              >
                <span className="relative whitespace-nowrap text-[13px] font-medium tracking-[-0.01em] transition-all duration-300 group-hover:translate-x-0.5 text-black">
                  {item.name}
                  <svg aria-hidden="true" viewBox="0 0 100 12" preserveAspectRatio="none" className="pointer-events-none absolute -bottom-[3px] left-0 h-[7px] w-full origin-left overflow-visible transition-all duration-500 ease-out scale-x-0 opacity-0 group-hover:scale-x-100 group-hover:opacity-100"><path d="M2 7C16 3 30 10 46 6 62 2 78 9 98 5" fill="none" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" vectorEffect="non-scaling-stroke"></path></svg>
                </span>
                <span className="ml-auto flex shrink-0 items-center leading-none transition-all duration-300 translate-x-1 text-transparent group-hover:translate-x-0 group-hover:text-[#3b82f6]"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-up-right size-3.5" aria-hidden="true"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg></span>
              </a>
            </li>
          ))}
        </ul>
