...
export const projects: Project[] = [
  {
    ...
    shortDescription: "Followed Sebastian Raschka's \"Build a Large Language Model (From Scratch)\" to implement a transformer, attention mechanism, and training loop in raw PyTorch.",
  ...
  },
  {
    ...
    shortDescription: "An automated pipeline handling CI/CD, monitoring, and version control so model deployment is never the bottleneck.",
  ...
  },
  {
    ...
    shortDescription: "A production-grade Retrieval-Augmented Generation system combining vector search and generative AI for enterprise-scale data retrieval.",
  ...
  },
  {
    ...
    shortDescription: "A convolutional neural network trained to classify animal species from facial images alone.",
  ...
  },
  {
    ...
    shortDescription: "A CNN-based classifier identifying lesion patterns on bean plant leaves to support early agricultural disease detection.",
  ...
  },
  {
    ...
    shortDescription: "An NLP classifier trained on a news headlines dataset to detect sarcastic intent in short text.",
    techStack: ["PyTorch", "NLP", "Text Classification"],
    githubUrl: "https://github.com/ksbisht941/pytorch-projects/news-headlines-dataset-for-sarcasm-detection",
  ...
  },
  {
    ...
    shortDescription: "An audio classification model trained to distinguish Quran recitation styles from raw audio data.",
    techStack: ["PyTorch", "Audio ML", "Signal Processing"],
    githubUrl: "https://github.com/ksbisht941/pytorch-projects/quran-recitations-for-audio-classification",
    thumbnail: "/projects/audio-classification.png"
  },
  {
    id: "rice-type-classification",
    title: "Sorting Grain by the Pixel",
    shortDescription: "A classification model distinguishing rice varieties from image data, exploring feature engineering on fine-grained visual differences.",
  ...
  },
  {
    ...
    shortDescription: "Exploratory analysis of WhatsApp chat data — surfacing patterns in messaging frequency, sentiment, and activity over time.",
  ...
  },
  {
    ...
    shortDescription: "A set of regression and ML models experimenting with feature engineering and algorithm selection for price prediction tasks.",
  ...
  },
  {
    ...
    shortDescription: "Production computer vision systems for photograph similarity matching, passport validation, and embassy-specific document preprocessing — built and shipped at Visa2Fly.",
